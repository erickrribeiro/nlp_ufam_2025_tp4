...
from src.nlp_ufam.tools import serper

def build_planning_task(agent: BaseAgent) -> Task: 
    return Task(
        description=(
...
def build_writing_task(agent: BaseAgent) -> Task:
    return Task(
        description=(
...
def build_editing_task(agent: BaseAgent) -> Task:
    return Task(
        description=(
